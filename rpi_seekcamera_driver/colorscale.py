...
# Modified to add more palettes and fix a bug or two
# Still a bit of code left that is not needed for Seek.py
...
class Gray1Palette(Palette):
    table = [ [0.0, 0.00, 0.00, 0.00, 1.00], # stops
              [0.0, 0.00, 0.00, 0.00, 0.99], # red
              [0.0, 0.00, 0.00, 0.00, 0.99], # green
              [0.0, 0.00, 0.00, 0.00, 0.99], # blue
            ]

class Rain1Palette(Palette):
#             Blk   Vio    Blu   Cyn    Grn   Yel    Red   Wht
    table = [ [0.0, 0.14,  0.28, 0.42,  0.56, 0.70,  0.84, 1.00], # stops
              [0.0, 0.99,  0.00, 0.00,  0.00, 0.99,  0.99, 1.00], # red
              [0.0, 0.00,  0.00, 0.99,  0.49, 0.99,  0.00, 1.00], # green
              [0.0, 0.99,  0.99, 0.99,  0.00, 0.00,  0.00, 1.00], # blue
            ]

class IronPalette(Palette):
    table = [ [0.0, 0.12, 0.25, 0.50, 0.75, 1.00], # stops
              [0.0, 0.00, 0.60, 0.99, 0.99, 0.99], # red
              [0.0, 0.00, 0.00, 0.24, 0.70, 0.99], # green
              [0.0, 0.50, 0.60, 0.24, 0.00, 0.99], # blue
            ]

class BlackHotPalette(Palette):
    table = [ [0.00, 1.00], # stops
              [0.99, 0.00], # red
              [0.99, 0.00], # green
              [0.99, 0.00], # blue
            ]

class WhiteHotPalette(Palette):
    table = [ [0.00, 1.00], # stops
              [0.00, 0.99], # red
              [0.00, 0.99], # green
              [0.00, 0.99], # blue
            ]
class RedGreenPalette(Palette):
    table = [ [0.00, 1.00], # stops
              [0.99, 0.00], # red
              [0.00, 0.99], # green
              [0.00, 0.00], # blue
...
class HotIronPalette(Palette):
    table = [ [0.0, 0.50, 0.75, 1.00], # stops
              [0.0, 0.99, 0.99, 0.99], # red
              [0.0, 0.00, 0.49, 0.99], # green
              [0.0, 0.00, 0.00, 0.99], # blue
            ]
...
#        percentage = float(gray_value)/(2**8-1)
        percentage = float(gray_value)/(255)
        stop = 0
